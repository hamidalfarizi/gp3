...
class Pelanggaran extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('Pelanggaran_pusdac_model');
    ...
    function index()
    {
        ...
        $data['_view'] = 'pusdac/pelanggaran/index';

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('pusdac/pelanggaran/index', $data);
    ...
    function detail ($id)
    {
        ...
        if (isset($data['siswa']['id'])) {
                $data['datafilter'] =$this->Pelanggaran_pusdac_model->filter_by_id_siswa($id);
                $data['detail'] =$this->Siswa_model->detail_data($id);
             
                $data['_view'] = 'pusdac/pelanggaran/detail';
                $this->load->view('template/header', $data);
                $this->load->view('template/sidebar', $data);
                $this->load->view('pusdac/pelanggaran/detail', $data);
                $this->load->view('template/footer', $data);
        } else
    ...
    function input_pelanggaran($id)
    {
        ...
        if(isset($data['siswa']['id']))
        {
            ...
            if($this->form_validation->run()) {
                ...
                $this->Pelanggaran_pusdac_model->tambah_pelanggaran($data);
                $this->Pelanggaran_pusdac_model->tambah_poin_pelanggaran($id_siswa, $datapoint, $poin_pelanggaran);
                ...
                redirect('pusdac/pelanggaran');
            }
            else
            {
                $data['pelanggaranringan'] = $this->Kategori_model->get_pelanggaran_pusdac_ringan();
                $data['pelanggaransedang'] = $this->Kategori_model->get_pelanggaran_pusdac_sedang();
                $data['pelanggaranberat'] = $this->Kategori_model->get_pelanggaran_pusdac_berat();
                $data['stafpusdac'] = $this->Kategori_model->get_staf_pusdac();
                $data['staftalim'] = $this->Kategori_model->get_staf_talim();
           
                $data['_view'] = 'pusdac/pelanggaran/input_pelanggaran';
                $this->load->view('template/header');
                $this->load->view('template/sidebar');
                $this->load->view('pusdac/pelanggaran/input_pelanggaran', $data);
    ...
    {   
        ...
        $data['pelanggaran'] = $this->Pelanggaran_pusdac_model->get_pelanggaran($id_pelanggaran);
        ...
        if(isset($data['pelanggaran']['id_pelanggaran']))
        {
            ...
            {   
                ...
                $this->Pelanggaran_pusdac_model->update_pelanggaran($id_pelanggaran,$params);
                ...
                redirect(base_url('pusdac/pelanggaran/detail/' . $id_siswa)) ;
            }
            else
            {
                $data['pelanggaranringan'] = $this->Kategori_model->get_pelanggaran_bahasa_ringan();
                $data['pelanggaransedang'] = $this->Kategori_model->get_pelanggaran_bahasa_sedang();
                $data['pelanggaranberat'] = $this->Kategori_model->get_pelanggaran_bahasa_berat();
                $data['staflac'] = $this->Kategori_model->get_staf_LAC();
                $data['stafcli'] = $this->Kategori_model->get_staf_CLI();

                $data['_view'] = 'pusdac/pelanggaran/edit_pelanggaran';
                $this->load->view('template/header',$data);
                $this->load->view('template/sidebar',$data);
                $this->load->view('pusdac/pelanggaran/edit_pelanggaran',$data);
                $this->load->view('template/footer',$data);
            }
        }
        else
    ...
    function hapus_pelanggaran($id_pelanggaran)
    {
        ...
        if(isset($data['pelanggaran']['id_pelanggaran']))
        {
            $this->Pelanggaran_pusdac_model->delete_pelanggaran($id_pelanggaran);
            ...
            redirect(base_url('pusdac/pelanggaran/detail/' . $data['pelanggaran']['id_siswa'])) ;
        } else
    ...
    function print()
    {
        ...
        if ($filterid == 1) {
            $data['datafilter'] =$this->Pelanggaran_pusdac_model->filter_by_id_siswa($id_siswa);
            $data['detail'] =$this->Siswa_model->detail_data($id_siswa);
        
            $data['_view'] = 'pusdac/pelanggaran/detail';
 
            $this->load->view('pusdac/pelanggaran/print_laporan', $data);
            $this->load->view('template/footer', $data);
        }
    }
    ...
    {   
        ...
        $this->load->view('template/header',$data);
        $this->load->view('template/sidebar',$data);
        $this->load->view('pusdac/pelanggaran/input_massal',$data);
        $this->load->view('template/footer',$data);
    }
    ...
    function simpan_massal()
    {
        ...
        $this->Pelanggaran_pusdac_model->tambah_poin_pelanggaran_massal($id_siswa, $datapoint, $poin_pelanggaran);
        ...
        $this->db->insert_batch('record_pelanggaran_bahasa', $params);
        
        redirect('pusdac/pelanggaran/tabel_pelanggaran');
    }
    ...
    function form_filter_tanggal ()
    {
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('pusdac/pelanggaran/form_filter_tanggal');
        $this->load->view('template/footer');
    }
    ...
    function filterbytanggal()
    {
        ...
        $data['pelanggaran'] = $this->Pelanggaran_pusdac_model->get_all_jenis_pelanggaran();
        ...
        if ($nilaitanggal == 1) {
            ...
            $data['databerbicarabahasaindonesia'] =$this->Pelanggaran_pusdac_model->filter_by_tanggal_bicaraindo($tanggalawal,$tanggalakhir);
            $data['databerbicarabahasadaerah'] =$this->Pelanggaran_pusdac_model->filter_by_tanggal_bicaradaerah($tanggalawal,$tanggalakhir);
            $data['databerbicaraperkataankasar'] =$this->Pelanggaran_pusdac_model->filter_by_tanggal_bicarakasar($tanggalawal,$tanggalakhir);
          
            $this->load->view('template/header', $data);
            $this->load->view('template/sidebar', $data);
            $this->load->view('pusdac/pelanggaran/print_grafik', $data);
            $this->load->view('template/footer', $data);
    ...
    {
        $data['pelanggaran_siswa'] = $this->Pelanggaran_pusdac_model->get_tabel_pelanggaran_siswa();

        $data['_view'] = 'pusdac/pelanggaran/tabel_indeks_pelanggaran';

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('pusdac/pelanggaran/tabel_indeks_pelanggaran', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    function filter ()
    {
        ...
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('bahasa/filter/index_pelanggaran', $data);
        $this->load->view('template/footer');
    }
    ...
    function filterbykategori()
    {
        ...
        if ($nilaipelanggaran == 1) {
            ...
            $data['datafilter'] =$this->Pelanggaran_pusdac_model->filter_by_pelanggaran($nama_pelanggaran);

            $this->load->view('bahasa/filter/print_laporan', $data);
            $this->load->view('template/footer', $data);
        ...
        if ($nilaipenghukum == 1) {
            ...
            $data['datafilter'] =$this->Pelanggaran_pusdac_model->filter_by_penghukum($penghukum);
        ...
        if ($nilaitanggal == 1) {
            ...
            $data['datafilter'] =$this->Pelanggaran_pusdac_model->filter_by_tanggal($tanggalawal,$tanggalakhir);
        ...
        if ($nilairayon == 1) {
            ...
            $data['datafilter'] =$this->Pelanggaran_pusdac_model->filterpelanggaran_by_rayon($rayon);
    ...
    {
        $data['pelanggaran_siswa'] = $this->Pelanggaran_pusdac_model->get_nama_distinct();

        $data['_view'] = 'pusdac/pelanggaran/tabel_rekap_poin';

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('pusdac/pelanggaran/tabel_rekap_poin', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    function hapus_point_siswa_20($id_siswa)
    {
        ...
        if(isset($data['siswa']['id']))
        {
            $this->Pelanggaran_pusdac_model->delete_point_pelanggaran_20($id_siswa);
            ...
            redirect(base_url('pusdac/pelanggaran/tabel_rekap_point/')) ;
        } else
        show_error('The siswa you are trying to delete does not exist.');
    }
    ...
    function hapus_point_siswa_25($id_siswa)
    {
        ...
        if(isset($data['siswa']['id']))
        {
            $this->Pelanggaran_pusdac_model->delete_point_pelanggaran_25($id_siswa);
    ...
    {   
        ...
        if(isset($data['pelanggaran']['id_pelanggaran']))
        {
            ...
            {   
                ...
                redirect(base_url('pusdac/pelanggaran/tabel_pelanggaran')) ;
            }
            else
            {
                $data['pelanggaranringan'] = $this->Kategori_model->get_pelanggaran_bahasa_ringan();
                ...
                $data['_view'] = 'pusdac/pelanggaran/edit_pelanggaran_tabel';
                $this->load->view('template/header',$data);
                $this->load->view('template/sidebar',$data);
                $this->load->view('pusdac/pelanggaran/edit_pelanggaran_tabel',$data);
                $this->load->view('template/footer',$data);
            }
        }
        else
    ...
    {
        // ambil data santri aktif
        $data['pelanggaran'] = $this->Pelanggaran_pusdac_model->get_all_kategori_pelanggaran();
        ...
        if($this->form_validation->run()) {
            ...
            $this->Pelanggaran_pusdac_model->tambah_kategori_pelanggaran($data);
            ...
            redirect('pusdac/pelanggaran/tambah_kategori_pelanggaran');
        }
        else
        {
            $data['_view'] = 'pusdac/pelanggaran/tambah_kategori_pelanggaran';
            $this->load->view('template/header');
            $this->load->view('template/sidebar');
            $this->load->view('pusdac/pelanggaran/tambah_kategori_pelanggaran', $data);
            $this->load->view('template/footer');
        }
    }
    ...
    {   
        // check if the pelanggaran exists before trying to edit it
        $data['kategori_pelanggaran'] = $this->Pelanggaran_pusdac_model->get_kategori_pelanggaran($id_kategori);
        ...
        if(isset($data['kategori_pelanggaran']['id']))
        {
            ...
            {   
                ...
                $this->Pelanggaran_pusdac_model->update_kategori_pelanggaran($id_kategori,$data);
                ...
                redirect(base_url('pusdac/pelanggaran/tambah_kategori_pelanggaran')) ;
            }
            else
            {
                
                $data['_view'] = 'pusdac/pelanggaran/edit_kategori_pelanggaran';
                $this->load->view('template/header',$data);
                $this->load->view('template/sidebar',$data);
                $this->load->view('pusdac/pelanggaran/edit_kategori_pelanggaran',$data);
                $this->load->view('template/footer',$data);
            }
        }
        else
    ...
    function hapus_kategori_pelanggaran($id_kategori)
    {
        ...
        if(isset($data['kategori_pelanggaran']['id']))
        {
            $this->Pelanggaran_pusdac_model->delete_kategori_pelanggaran($id_kategori);
    ...
    function fill_kategori_pelanggaran(){
        ...
        $s = "SELECT * FROM tb_pelanggaran_pusdac WHERE nama_pelanggaran='$nama_pelanggaran'";
