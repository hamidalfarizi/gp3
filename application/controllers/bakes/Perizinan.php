...
class Perizinan extends CI_Controller
{
    function __construct()
    {
        ...
        $this->load->model('Perizinan_bakes_model');
    ...
    function index()
    {
        ...
        $data['_view'] = 'bakes/perizinan/index';

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('bakes/perizinan/index', $data);
    ...
    function detail ($id)
    {
        ...
        if (isset($data['siswa']['id'])) {
                $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_id_siswa($id);
                $data['detail'] =$this->Siswa_model->detail_data($id);
             
                $data['_view'] = 'bakes/perizinan/detail';
                $this->load->view('template/header', $data);
                $this->load->view('template/sidebar', $data);
                $this->load->view('bakes/perizinan/detail', $data);
                $this->load->view('template/footer', $data);
        } else
    ...
    function input_perizinan($id)
    {
        ...
        if(isset($data['siswa']['id']))
        {
            ...
            if($this->form_validation->run()) {
                ...
                $this->Perizinan_bakes_model->tambah_perizinan($data);
            ...
            else
            {
                ...
                $data['_view'] = 'bakes/perizinan/input_perizinan';
                $this->load->view('template/header');
                $this->load->view('template/sidebar');
                $this->load->view('bakes/perizinan/input_perizinan', $data);
    ...
    {   
        ...
        $data['perizinan'] = $this->Perizinan_bakes_model->get_perizinan($id_perizinan);
        ...
        if(isset($data['perizinan']['id_perizinan']))
        {
            ...
            {   
                ...
                $this->Perizinan_bakes_model->update_perizinan($id_perizinan,$params);
                ...
                redirect(base_url('bakes/perizinan/detail/' . $id_siswa)) ;
            }
            else
            {
                $data['stafbakes'] = $this->Kategori_model->get_staf_bakes();
                ...
                $data['_view'] = 'bakes/perizinan/edit_perizinan';
                $this->load->view('template/header',$data);
                $this->load->view('template/sidebar',$data);
                $this->load->view('bakes/perizinan/edit_perizinan',$data);
                $this->load->view('template/footer',$data);
            }
        }
        else
    ...
    function hapus_perizinan($id_perizinan)
    {
        ...
        if(isset($data['perizinan']['id_perizinan']))
        {
            $this->Perizinan_bakes_model->delete_perizinan($id_perizinan);
            ...
            redirect(base_url('bakes/perizinan/detail/' . $data['perizinan']['id_siswa'])) ;
        } else
    ...
    function print()
    {
        ...
        if ($filterid == 1) {
            $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_id_siswa($id_siswa);
            $data['detail'] =$this->Siswa_model->detail_data($id_siswa);
        
            $data['_view'] = 'perizinan/detail';
 
            $this->load->view('bakes/perizinan/print_laporan', $data);
            $this->load->view('template/footer', $data);
        }
    }
    ...
    function form_filter_tanggal ()
    {
        $this->load->view('template/header');
        $this->load->view('template/sidebar');
        $this->load->view('bakes/perizinan/form_filter_tanggal');
        $this->load->view('template/footer');
    }
    ...
    function filterbytanggal()
    {
        ...
        if ($nilaitanggal == 1) {
            ...
            $data['dataizinrumah'] =$this->Perizinan_bakes_model->count_izin_rumah($tanggalawal,$tanggalakhir);
            $data['dataizinrumahsakit'] =$this->Perizinan_bakes_model->count_izin_rumah_sakit($tanggalawal,$tanggalakhir);
    
            $this->load->view('template/header', $data);
            $this->load->view('template/sidebar', $data);
            $this->load->view('bakes/perizinan/print_grafik', $data);
            $this->load->view('template/footer', $data);
    ...
    {   
        ...
        $this->load->view('template/header',$data);
        $this->load->view('template/sidebar',$data);
        $this->load->view('bakes/perizinan/input_massal',$data);
        $this->load->view('template/footer',$data);
    }
    ...
    function simpan_massal()
    {
        ...
        $this->db->insert_batch('record_perizinan_bakes', $params);
        redirect('bakes/perizinan/tabel_perizinan');
    }
    ...
    {
        $data['perizinan_siswa'] = $this->Perizinan_bakes_model->get_tabel_perizinan_siswa();

        $data['_view'] = 'bakes/perizinan/tabel_indeks_perizinan';

        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar', $data);
        $this->load->view('bakes/perizinan/tabel_indeks_perizinan', $data);
        $this->load->view('template/footer', $data);
    }
    ...
    function filterbykategori()
    {
        ...
        if ($nilaiperizinan == 1) {
            ...
            $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_perizinan($nama_perizinan);
        ...
        if ($nilaitujuan == 1) {
            ...
            $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_tujuan($tujuan);
        ...
        if ($nilaipengizin == 1) {
            ...
            $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_pengizin($pengizin);
        ...
        if ($nilaitanggal == 1) {
            ...
            $data['datafilter'] =$this->Perizinan_bakes_model->filter_by_tanggal($tanggalawal,$tanggalakhir);
        ...
        if ($nilairayon == 1) {
            ...
            $data['datafilter'] =$this->Perizinan_bakes_model->filterperizinan_by_rayon($rayon);
    ...
    {   
        ...
        if(isset($data['perizinan']['id_perizinan']))
        {
            ...
            {   
                ...
                redirect(base_url('bakes/perizinan/tabel_perizinan')) ;
            }
            else
            {
                ...
                $data['_view'] = 'bakes/perizinan/edit_perizinan_tabel';
                $this->load->view('template/header',$data);
                $this->load->view('template/sidebar',$data);
                $this->load->view('bakes/perizinan/edit_perizinan_tabel',$data);
                $this->load->view('template/footer',$data);
            }
        }
        else
