...
class Pelanggaran extends CI_Controller
{
    ...
    {   
        ...
        if(isset($data['pelanggaran']['id_pelanggaran']))
        {
            ...
            {   
                ...
                $this->session->set_flashdata('berhasil', 'Anda berhasil mengubah data hukuman pelanggaran <strong>' . $nama_siswa . '</strong>' . ' menjadi <strong>' . $this->input->post('hukuman') . '</strong>');
    ...
    function filterbykategori()
    {
        ...
        $nilaihukuman = $this->input->post('nilaihukuman');
        ...
        if ($nilaihukuman == 1) {
            $data['title'] = "Data Santri Yang Mendapat Hukuman $hukuman";
            $data['datafilter'] =$this->Pelanggaran_pengasuhan_model->filter_by_hukuman($hukuman);
