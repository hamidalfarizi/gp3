...
<div class="container-fluid text-dark">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><strong>Edit Kategori Pelanggaran Pengasuhan Santri</strong></h1>
	</div>
	...
	<div class="card shadow mb-1">
		<div class="card-header" >
			<h4 class="h4 mb-0 text-gray-800"><strong>Edit Kategori Pelanggaran</strong></h4>
		</div>
		<div class="card-body">
			<form action="<?= base_url('pengasuhan/pelanggaran/edit_kategori_pelanggaran/' . $kategori_pelanggaran['id']) ?>" method="post">
				...
				<a href="<?= base_url('pengasuhan/pelanggaran/tambah_kategori_pelanggaran'); ?>" class='btn btn-danger'>Kembali</a>
			</form>
		</div>
	</div>
	<br>
