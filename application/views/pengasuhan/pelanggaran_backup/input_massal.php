	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<?php echo form_open('pengasuhan/pelanggaran/simpan_massal', array("class" => "form-horizontal")); ?>
				<div class="card-body">
					<div class="row">
						<div class="col-md-4">
				...
				<div class="card-footer">
					<div class="form-group">
						...
						<a href="<?= base_url('pengasuhan/pelanggaran') ?>" class='btn btn-secondary'>Batal</a>
					</div>
				</div>
				<?php echo form_close(); ?>
			</div>
