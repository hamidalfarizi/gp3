...
<div class="container-fluid text-dark">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><strong>Tambah Kategori Pelanggaran Pengasuhan Santri</strong></h1>
	</div>
	...
	<div class="card shadow mb-1">
		<div class="card-header" >
			<h4 class="h4 mb-0 text-gray-800"><strong>Tambah Kategori Pelanggaran</strong></h4>
		</div>
		<div class="card-body">
			<form action="<?= base_url('pengasuhan/pelanggaran/tambah_kategori_pelanggaran') ?>" method="post">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php foreach ($pelanggaran as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('pengasuhan/pelanggaran/edit_kategori_pelanggaran/' . $m['id']); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-pen"></i>
									</span>
								</a>
								<a href="<?php echo site_url('pengasuhan/pelanggaran/hapus_kategori_pelanggaran/' . $m['id']); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
