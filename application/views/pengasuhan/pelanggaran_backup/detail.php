...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
			...
			<form action="<?= base_url('pengasuhan/pelanggaran/print/' . $row->id_siswa)  ?>" method="post" target='_blank'>
						...
						<table id="datatable-guru" class="table table-striped table-bordered " style="width:100%">
							...
							<tbody>
								<tr>
									...
									<td><?php echo array_sum(array_column($datafilter,'id_pelanggaran'));?></td>
									<td>
									<a href="<?php echo site_url('pengasuhan/pelanggaran/hapus_pelanggaran/' . $row->id_pelanggaran ); ?>" class="btn btn-danger btn-sm">
										<span class="icon text-white-50">
											<i class="fas fa-trash"></i>
										</span>
									</a>
									<a href="<?php echo site_url('pengasuhan/pelanggaran/edit_pelanggaran/' . $row->id_pelanggaran ); ?>" class="btn btn-primary btn-sm">
										<span class="icon text-white-50">
	...
	<div>
		<div class="col-sm-offset-4 col-sm-8">
			<a href="<?= base_url('pengasuhan/pelanggaran'); ?>" class='btn btn-danger'>Kembali</a>
