		...
		<div class="col-12">
			<div class="card shadow mb-4">
                 <div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Filter Data Pelanggaran Santri (Pengasuhan)</h3>
                    <hr>
                    <br>
                    Form Filter By Tanggal Melanggar
                    <hr>

                    <form action="<?php echo base_url(); ?>pengasuhan/pelanggaran/filterbytanggal" method="POST" target='_blank'>
