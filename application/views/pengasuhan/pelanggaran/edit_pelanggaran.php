		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Edit Pelanggaran Santri (Pengasuhan)</h3>
				</div>
				<div class="card-body">
					<form action="<?= base_url('pengasuhan/pelanggaran/edit_pelanggaran/' . $pelanggaran['id_pelanggaran']) ?>" method="post">
					...
					<a href="<?= base_url('pengasuhan/pelanggaran/detail/' . $detail->id); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
