		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Input Pelanggaran Santri (Pengasuhan)</h3>
				</div>
				<div class="card-body">
					<form action="<?= base_url('pengasuhan/pelanggaran/input_pelanggaran/'. $detail->id ) ?>" method="post">
						...
						<tr>
							...
							<td>
								<select name="penghukum" id="penghukum"  placeholder="Test" class="form-control" required >
									...
									<optgroup label="Staf Keamanan Pusat">
									...
									<optgroup label="Pengurus Rayon">
									<?php foreach ($penghukumrayon as $row): ?>
