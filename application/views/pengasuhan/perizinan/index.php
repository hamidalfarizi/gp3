...
<div class="container-fluid text-dark">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><strong>Input Perizinan Pengasuhan Santri</strong></h1>
	</div>
	...
	<?php } ?>
		...
		<div class="row mb-4">
			<div class="col">
				<a href="<?= base_url('pengasuhan/perizinan/input_massal'); ?>" class="btn btn-info btn-icon-split">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php foreach ($siswa as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('pengasuhan/perizinan/input_perizinan/' . $m['id']); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-pen"></i>
									</span>
								</a>
								<a href="<?php echo site_url('pengasuhan/perizinan/detail/' . $m['id']); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
