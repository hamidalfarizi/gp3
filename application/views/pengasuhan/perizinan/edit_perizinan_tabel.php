	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('pengasuhan/perizinan/edit_perizinan_tabel/' . $perizinan['id_perizinan']) ?>" method="post">
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<input type="text" name="kategori" class="form-control" id="kategori" value="<?php echo $perizinan['nama_perizinan'] ?>" readonly>
								</div>
							</td>	
						</tr>
						<tr>
					...
					<a href="<?= base_url('pengasuhan/perizinan/tabel_perizinan'); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
