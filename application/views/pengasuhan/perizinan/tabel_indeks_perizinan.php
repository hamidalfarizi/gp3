...
<div class="container-fluid text-dark">
	...
	<div class="row mb-4">
		<div class="col">
			<a href="<?= base_url('pengasuhan/perizinan/filter'); ?>" class="btn btn-info btn-icon-split">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php $no=1; foreach ($perizinan_siswa as $m) { ?>
						<tr>
							...
							<td><?php echo $m['dari_tanggal']; ?></td>
							<td><?php echo $m['sampai_tanggal']; ?></td>
							<td><?php echo $m['nama_penghukum']; ?></td>
							<td><?php echo $m['tujuan']; ?></td>
							<td><?php echo $m['keterangan']; ?></td>
							<td><?php echo $m['alasan']; ?></td>
							<td>
								<a href="<?php echo site_url('pengasuhan/perizinan/hapus_perizinan_tabel/' . $m['id_perizinan'] ); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-trash"></i>
									</span>
								</a>
								<a href="<?php echo site_url('pengasuhan/perizinan/edit_perizinan_tabel/' . $m['id_perizinan'] ); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
