			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="form-group row">
						...
						<input type="text" name="nama" value="<?php echo $this->input->post('nama'); ?>" class="col-sm-4 form-control" id="nama" />
						<span class="text-danger"><?php echo form_error('nama'); ?></span>
					</div>
					<div class="form-group row">
						<label for="kode_kelas" class="col-sm-2 control-label">Kode Kelas</label>
						<input type="text" name="kode_kelas" value="<?php echo $this->input->post('kode_kelas'); ?>" class="col-sm-1 form-control" id="kode_kelas" />
					</div>
