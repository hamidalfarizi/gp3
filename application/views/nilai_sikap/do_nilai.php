...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<h3 class="m-0 font-weight-bold text-primary text-uppercase">Nilai Sikap Kelas <?=$kelas['nama']; ?></h3>
		</div>
		<div class="card-header py-3">
			<h5 class="m-0 font-weight-bold text-primary text-uppercase">Ustadz <?= user_info()['first_name']; ?> <?= user_info()['last_name']; ?></h5>
		</div>
		<div class="card-body">
