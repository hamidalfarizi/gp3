...
<div class="container-fluid text-dark">
	...
	<div class="card shadow mb-1">
		...
		<div class="card-body">
			<form action="<?= base_url('pusdac/pelanggaran/edit_kategori_pelanggaran/' . $kategori_pelanggaran['id']) ?>" method="post">
				...
				<a href="<?= base_url('pusdac/pelanggaran/tambah_kategori_pelanggaran'); ?>" class='btn btn-danger'>Kembali</a>
			</form>
		</div>
	</div>
	<br>
