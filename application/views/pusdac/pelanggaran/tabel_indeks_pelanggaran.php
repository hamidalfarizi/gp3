				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php $no=1; foreach ($pelanggaran_siswa as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('pusdac/pelanggaran/hapus_pelanggaran_tabel/' . $m['id_pelanggaran'] ); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-trash"></i>
									</span>
								</a>
								<a href="<?php echo site_url('pusdac/pelanggaran/edit_pelanggaran_tabel/' . $m['id_pelanggaran'] ); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
