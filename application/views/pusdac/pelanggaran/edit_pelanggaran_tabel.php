	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('pusdac/pelanggaran/edit_pelanggaran_tabel/' . $pelanggaran['id_pelanggaran']) ?>" method="post">
					...
					<a href="<?= base_url('pusdac/pelanggaran/tabel_pelanggaran'); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
