	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('bahasa/perizinan/edit_perizinan_tabel/' . $perizinan['id_perizinan']) ?>" method="post">
					...
					<a href="<?= base_url('bahasa/perizinan/detail/' . $detail->id); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
