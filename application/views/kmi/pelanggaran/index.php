...
<div class="container-fluid text-dark">
	...
	<h1 class="h3 mb-0 text-gray-800"><strong>Input Pelanggaran Staf KMI</strong></h1>
	</div>
	...
	<?php } ?>
		...
		<div class="row mb-4">
			<div class="col">
				<a href="<?= base_url('kmi/pelanggaran/input_massal'); ?>" class="btn btn-info btn-icon-split">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php foreach ($siswa as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('kmi/pelanggaran/input_pelanggaran/' . $m['id']); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-pen"></i>
									</span>
								</a>
								<a href="<?php echo site_url('kmi/pelanggaran/detail/' . $m['id']); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
