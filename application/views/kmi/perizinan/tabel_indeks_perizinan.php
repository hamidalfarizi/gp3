...
<div class="container-fluid text-dark">
	...
	<div class="row mb-4">
		<div class="col">
			<a href="<?= base_url('kmi/perizinan/filter'); ?>" class="btn btn-info btn-icon-split">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php $no=1; foreach ($perizinan_siswa as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('kmi/perizinan/hapus_perizinan_tabel/' . $m['id_perizinan'] ); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-trash"></i>
									</span>
								</a>
								<a href="<?php echo site_url('kmi/perizinan/edit_perizinan_tabel/' . $m['id_perizinan'] ); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
