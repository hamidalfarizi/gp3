...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		...
		<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
			...
			<form action="<?= base_url('kmi/perizinan/print/' . $row->id_siswa)  ?>" method="post" target='_blank'>
						...
						<table id="datatable-guru" class="table table-striped table-bordered " style="width:100%">
							...
							<tbody>
								<tr>
									...
									<td>
										<a href="<?php echo site_url('kmi/perizinan/hapus_perizinan/' . $row->id_perizinan ); ?>" class="btn btn-danger btn-sm">
											<span class="icon text-white-50">
												<i class="fas fa-trash"></i>
											</span>
										</a>
										<a href="<?php echo site_url('kmi/perizinan/edit_perizinan/' . $row->id_perizinan ); ?>" class="btn btn-primary btn-sm">
											<span class="icon text-white-50">
