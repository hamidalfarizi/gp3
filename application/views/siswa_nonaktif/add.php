			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="row">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label for="no_kis">No KIS (Nomor Kartu Indoesia Sehat)</label>
								<input type="text" pattern="\d*" name="no_kis" value="<?php echo $this->input->post('no_kis'); ?>" class="form-control" id="no_kis" maxlength="13"/>
							</div>
						</div>
					</div>
					<div class="row">
