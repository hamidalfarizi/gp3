	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<div class="form-group row">
				<label for="nama_lengkap" class="col-md-2 control-label"><span class="text-danger">*</span>Nama
					Lengkap</label>
				<div class="col-md-4">
			...
			<div class="form-group row">
				<label for="jenis_kelamin" class="col-md-2 control-label"><span class="text-danger">*</span>Jenis
					Kelamin</label>
				<div class="col-md-2">
			...
			<div class="form-group row">
				<label for="nip" class="col-md-2 control-label">Kamar</label>
				<div class="col-md-4">
			...
			<div class="form-group row">
				<label for="nik" class="col-md-2 control-label">Nomor Induk Kependudukan</label>
				<div class="col-md-2">
			...
			<div class="form-group row">
				<label for="no_kis" class="col-md-2 control-label">Nomor BPJS</label>
				<div class="col-md-4">
					<input type="text" name="no_kis"
						value="<?php echo ($this->input->post('no_kis') ? $this->input->post('no_kis') : $guru['no_kis']); ?>"
			...
			<div class="form-group row">
				<label for="gelar_depan" class="col-md-2 control-label">Gelar Depan</label>
				<div class="col-md-2">
			...
			<div class="form-group row">
				<label for="gelar_belakang" class="col-md-2 control-label">Gelar Belakang</label>
				<div class="col-md-2">
			...
			<div class="form-group row">
				<label for="pendidikan_terakhir" class="col-md-2 control-label">Pendidikan Terakhir</label>
				<div class="col-md-4">
