		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Input Perizinan Santri</h3>
				</div>
				<div class="card-body">
					<form action="<?= base_url('bahasa/perizinan/input_perizinan/'. $detail->id ) ?>" method="post">
...
<script>
	function pilih_perizinan(){
		...
		$.ajax({
			url:"<?php echo base_url() ?>bahasa/perizinan/fill_kategori_perizinan",
