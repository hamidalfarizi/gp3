...
<div class="container-fluid text-dark">
	...
	<div class="card shadow mb-1">
		...
		<div class="card-body">
			<form action="<?= base_url('bahasa/pelanggaran/tambah_kategori_pelanggaran') ?>" method="post">
				...
				<table id="datatable-siswa" class="table table-striped table-dark table-bordered table-hover" width="100%">
					...
					<?php $no=1; foreach ($pelanggaran as $m) { ?>
						<tr>
							...
							<td>
								<a href="<?php echo site_url('bahasa/pelanggaran/edit_kategori_pelanggaran/' . $m['id']); ?>" class="btn btn-danger btn-sm">
									<span class="icon text-white-50">
										<i class="fas fa-pen"></i>
									</span>
								</a>
								<a href="<?php echo site_url('bahasa/pelanggaran/hapus_kategori_pelanggaran/' . $m['id']); ?>" class="btn btn-primary btn-sm">
									<span class="icon text-white-50">
