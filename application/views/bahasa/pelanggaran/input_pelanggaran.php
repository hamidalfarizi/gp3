		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Input Pelanggaran Santri (Bahasa)</h3>
				</div>
				<div class="card-body">
					<form action="<?= base_url('bahasa/pelanggaran/input_pelanggaran/'. $detail->id ) ?>" method="post">
...
<script>
	function pilih_pelanggaran(){
		...
		$.ajax({
			url:"<?php echo base_url() ?>bahasa/pelanggaran/fill_kategori_pelanggaran",
