	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group row">
				<label for="id_mapel" class="col-md-3 control-label">Mapel</label>
				<div class="col-md-3">
			...
			<div class="form-group row">
				<label for="tingkat" class="col-md-3 control-label">Kelas Tingkat</label>
				<div class="col-md-3">
			...
			<div class="form-group row">
				<label for="" class="col-md-3 control-label">Jenis</label>
				<div class="col-md-3">
