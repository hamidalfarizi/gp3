					...
					<div class="tab-content" id="pills-tabContent">
						<div class="tab-pane fade show active" id="pills-identitas" role="tabpanel" aria-labelledby="pills-identitas-tab">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										<label for="nisn">Tahun Masuk Gontor</label>
										<input type="Number" pattern="\d*" name="nisn" value="<?php echo $this->input->post('nisn'); ?>" class="form-control" id="nisn" />
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="nama_arab" value="<?php echo $this->input->post('nama_arab'); ?>" class="form-control" id="nama_arab" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" pattern="\d*" name="nik" value="<?php echo $this->input->post('nik'); ?>" class="form-control" id="nik" min="0" maxlength="16"/>
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="no_kis">No BPJS (Jikalau Ada)</label>
										<input type="number" pattern="\d*" name="no_kis" value="<?php echo $this->input->post('no_kis'); ?>" class="form-control" id="no_kis" min="0" maxlength="13"/>
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<select name="kota_kab" class="form-control" id="kabupaten" >
											<option value="">Pilih</option>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="dibesarkan_di" value="<?php echo $this->input->post('dibesarkan_di'); ?>" class="form-control" id="dibesarkan_di"/>
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="tab-pane fade" id="pills-ayah" role="tabpanel" aria-labelledby="pills-ayah-tab">
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="text" name="agama_ayah" value="<?php echo $this->input->post('agama_ayah'); ?>" class="form-control" id="pend_ayah" />
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
										<label for="usia_ayah">Usia</label>
										<input type="number" name="usia_ayah" value="<?php echo $this->input->post('usia_ayah'); ?>" class="form-control" id="usia_ayah" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="pend_ayah">Pendidikan Terakhir</label>
										<input type="text" name="pend_ayah" value="<?php echo $this->input->post('pend_ayah'); ?>" class="form-control" id="pend_ayah" />
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="suku_ayah" value="<?php echo $this->input->post('suku_ayah'); ?>" class="form-control" id="suku_ayah" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="ormas_ayah" value="<?php echo $this->input->post('ormas_ayah'); ?>" class="form-control" id="ormas_ayah" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="orpol_ayah">ORPOL</label>
										<input type="text" name="orpol_ayah" value="<?php echo $this->input->post('orpol_ayah'); ?>" class="form-control" id="orpol_ayah" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="kedudukan_ayah" value="<?php echo $this->input->post('kedudukan_ayah'); ?>" class="form-control" id="kedudukan_ayah" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<div>
											<select name="alumni_ayah" class="form-control" id="my_Select_Ayah" onchange="my_Function_Ayah()">
												<option value="">Pilih</option>
												<?php
												$aktif_values = array(
													'Ya' => 'Ya',
							...
							<div class="row" id="show_alumni_ayah" style='visibility:hidden'>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="stambuk_ayah">Stambuk</label>
										<input type="number" name="stambuk_ayah" value="<?php echo $this->input->post('stambuk_ayah'); ?>" class="form-control" id="stambuk_ayah" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="tahun_lulus_ayah">Tahun Lulus</label>
										<input type="date" name="tahun_lulus_ayah" value="<?php echo $this->input->post('tahun_lulus_ayah'); ?>" class="form-control" id="tahun_lulus_ayah" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="text" name="agama_ibu" value="<?php echo $this->input->post('agama_ibu'); ?>" class="form-control" id="agama_ibu" />
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
										<label for="usia_ibu">Usia</label>
										<input type="number" name="usia_ibu" value="<?php echo $this->input->post('usia_ibu'); ?>" class="form-control" id="usia_ibu" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="pend_ibu">Pendidikan Terakhir</label>
										<input type="text" name="pend_ibu" value="<?php echo $this->input->post('pend_ibu'); ?>" class="form-control" id="pend_ibu" />
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="suku_ibu" value="<?php echo $this->input->post('suku_ibu'); ?>" class="form-control" id="suku_ibu" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="ormas_ibu" value="<?php echo $this->input->post('ormas_ibu'); ?>" class="form-control" id="ormas_ibu" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="orpal_ibu">ORPOL</label>
										<input type="text" name="orpal_ibu" value="<?php echo $this->input->post('orpal_ibu'); ?>" class="form-control" id="orpal_ibu" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="kedudukan_ibu" value="<?php echo $this->input->post('kedudukan_ibu'); ?>" class="form-control" id="kedudukan_ibu" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
							...
							<div class="row" id="showAlumniIbu" style='visibility:hidden'>
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" name="stambuk_ibu" value="<?php echo $this->input->post('stambuk_ibu'); ?>" class="form-control" id="stambuk_ibu" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="tahun_lulus_ibu">Tahun Lulus</label>
										<input type="date" name="tahun_lulus_ibu" value="<?php echo $this->input->post('tahun_lulus_ibu'); ?>" class="form-control" id="tahun_lulus_ibu" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" name="minimal_membiayai" value="<?php echo $this->input->post('minimal_membiayai'); ?>" class="form-control" id="minimal_membiayai" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="maksimal_membiayai">Maksimal Membiayai</label>
										<input type="number" name="maksimal_membiayai" value="<?php echo $this->input->post('maksimal_membiayai'); ?>" class="form-control" id="maksimal_membiayai" />
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="hubungan_wali" value="<?php echo $this->input->post('hubungan_wali'); ?>" class="form-control" id="hubungan_wali" />
									</div>
								</div>
							</div>
							<div class="row">	
							...
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="text" name="agama_wali" value="<?php echo $this->input->post('agama_wali'); ?>" class="form-control" id="agama_wali" />
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
										<label for="usia_wali">Usia</label>
										<input type="number" name="usia_wali" value="<?php echo $this->input->post('usia_wali'); ?>" class="form-control" id="usia_wali" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="pend_wali">Pendidikan Terakhir</label>
										<input type="text" name="pend_wali" value="<?php echo $this->input->post('pend_wali'); ?>" class="form-control" id="pend_wali" />
									</div>
								</div>
							</div>
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="suku_wali" value="<?php echo $this->input->post('suku_wali'); ?>" class="form-control" id="suku_wali" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="ormas_wali" value="<?php echo $this->input->post('ormas_wali'); ?>" class="form-control" id="ormas_wali" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="orpol_wali">ORPOL</label>
										<input type="text" name="orpol_wali" value="<?php echo $this->input->post('orpol_wali'); ?>" class="form-control" id="orpol_wali" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="kedudukan_wali" value="<?php echo $this->input->post('kedudukan_wali'); ?>" class="form-control" id="kedudukan_wali" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="telp_wali">Telp Wali</label>
										<input type="tel" pattern="[0-9]{4}-[0-9]{4}-[0-9]{4}" name="telp_wali" value="<?php echo $this->input->post('telp_wali'); ?>" class="form-control" id="telp_wali" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row" id="showAlumniWali" style='visibility:hidden'>
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="number" name="stambuk_wali" value="<?php echo $this->input->post('stambuk_wali'); ?>" class="form-control" id="stambuk_wali" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="tahun_lulus_wali">Tahun Lulus</label>
										<input type="date" name="tahun_lulus_wali" value="<?php echo $this->input->post('tahun_lulus_wali'); ?>" class="form-control" id="tahun_lulus_wali" />
									</div>
								</div>
							</div>
						</div>
						<div class="tab-pane fade" id="pills-data-fisik" role="tabpanel" aria-labelledby="pills-data-fisik-tab">
							<h3 class="text-info font-weight-bold">Data Fisik</h3>
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										<label for="tinggi_badan">Tinggi Badan (Centimeter)</label>
										<input type="text" name="tinggi_badan" value="<?php echo $this->input->post('tinggi_badan'); ?>" class="form-control" id="tinggi_badan" />
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
										<label for="berat_badan">Berat Badan (Kilogram)</label>
										<input type="text" name="berat_badan" value="<?php echo $this->input->post('berat_badan'); ?>" class="form-control" id="berat_badan" />
									</div>
								</div>
								<div class="col-sm-2">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-2">
									<div class="form-group">
										...
										<div>
											<select name="pakai_kacamata" class="form-control">
												<option value="">Pilih</option>
												<?php
												$aktif_values = array(
													'Ya' => 'Ya',
								...
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="date" name="kacamata_tahun" value="<?php echo $this->input->post('kacamata_tahun'); ?>" class="form-control" id="kacamata_tahun" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								...
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="date" name="alergi_dari_tahun" value="<?php echo $this->input->post('alergi_dari_tahun'); ?>" class="form-control" id="alergi_dari_tahun" />
									</div>
								</div>
							</div>		
							<div class="row">
								<div class="col-sm-2">
									<div class="form-group">
										...
										<input type="text" name="jenis_alergi" value="<?php echo $this->input->post('jenis_alergi'); ?>" class="form-control" id="jenis_alergi" />
									</div>
								</div>	
								<div class="col-sm-2">
									<div class="form-group">
										<label for="kelainan_fisik">Kelainan Fisik</label>
										<input type="text" name="kelainan_fisik" value="<?php echo $this->input->post('kelainan_fisik'); ?>" class="form-control" id="kelainan_fisik" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="letak_rumah" value="<?php echo $this->input->post('letak_rumah'); ?>" class="form-control" id="letak_rumah" />
									</div>
								</div>
							</div>
							<div class="row">
						...
						<div class="tab-pane fade" id="pills-penyakit" role="tabpanel" aria-labelledby="pills-penyakit-tab">
							<h3 class="text-info font-weight-bold">Data Penyakit Yang Pernah Diderita</h3>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										<label for="sakit_tahun">Tahun</label>
										<input type="text" name="sakit_tahun" value="<?php echo $this->input->post('sakit_tahun'); ?>" class="form-control" id="sakit_tahun" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="sakit_nama">Nama Penyakit</label>
										<input type="text" name="sakit_nama" value="<?php echo $this->input->post('sakit_nama'); ?>" class="form-control" id="sakit_nama" />
									</div>
								</div>
							</div>
							<div class="row">
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="sakit_keterangan" value="<?php echo $this->input->post('sakit_keterangan'); ?>" class="form-control" id="sakit_keterangan" />
									</div>
								</div>	
							</div>
						</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="bidang_studi" value="<?php echo $this->input->post('bidang_studi'); ?>" class="form-control" id="bidang_studi" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="olah_raga">Olahraga</label>
										<input type="text" name="olah_raga" value="<?php echo $this->input->post('olah_raga'); ?>" class="form-control" id="olah_raga" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="kesenian" value="<?php echo $this->input->post('kesenian'); ?>" class="form-control" id="kesenian" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="keterampilan">Keterampilan</label>
										<input type="text" name="keterampilan" value="<?php echo $this->input->post('keterampilan'); ?>" class="form-control" id="keterampilan" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="lain_lain" value="<?php echo $this->input->post('lain_lain'); ?>" class="form-control" id="lain_lain" />
									</div>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="klub_olah_raga" value="<?php echo $this->input->post('klub_olah_raga'); ?>" class="form-control" id="klub_olah_raga" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="kursus_bahasa">Kursus Bahasa</label>
										<input type="text" name="kursus_bahasa" value="<?php echo $this->input->post('kursus_bahasa'); ?>" class="form-control" id="kursus_bahasa" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="kursus_kesenian" value="<?php echo $this->input->post('kursus_kesenian'); ?>" class="form-control" id="kursus_kesenian" />
									</div>
								</div>
								<div class="col-sm-4">
									<div class="form-group">
										<label for="ketermpilan_extra">Keterampilan</label>
										<input type="text" name="ketermpilan_extra" value="<?php echo $this->input->post('ketermpilan_extra'); ?>" class="form-control" id="ketermpilan_extra" />
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-4">
									<div class="form-group">
										...
										<input type="text" name="asisten_bagian" value="<?php echo $this->input->post('asisten_bagian'); ?>" class="form-control" id="asisten_bagian" />
									</div>
								</div>
							</div>
						</div>			
...
<script>
        $(document).ready(function(){
            $("#provinsi").change(function (){
                var url = "<?php echo site_url('siswa/add_ajax_kab');?>/"+$("#provinsi").val();
				var nama_prov = $("#provinsi").val();
				$.post (nama_prov)
                $('#kabupaten').load(url);
                return false;
            })
   			...
   			$("#kabupaten").change(function (){
                var url = "<?php echo site_url('siswa/add_ajax_kec');?>/"+$(this).val();
                $('#kecamatan').load(url);
                return false;
            })
   
   			$("#kecamatan").change(function (){
                var url = "<?php echo site_url('siswa/add_ajax_des');?>/"+$(this).val();
                $('#desa').load(url);
                return false;
            })
        });
