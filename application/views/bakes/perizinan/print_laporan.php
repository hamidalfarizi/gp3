...
<title> Print Data Perizinan <?php echo $detail->nama_lengkap ?> Kelas <?php echo $detail->kelas ?> </title>

<br><br>
	<!-- page heading -->
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h2 mb-0 text-gray-800"><strong> Rekap Data Perizinan Santri</strong> </h1>
	</div>
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
