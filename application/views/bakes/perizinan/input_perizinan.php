		...
		<div class="col-12">
			<div class="card shadow mb-4">
				<div class="card-header py-3">
					<h3 class="m-0 font-weight-bold text-primary">Input Perizinan Berobat Santri</h3>
				</div>
				<div class="card-body">
					<form action="<?= base_url('bakes/perizinan/input_perizinan/'. $detail->id ) ?>" method="post">
						...
						<tr>
							<th>Pengizin</th>
							<td>
								<select name="pengizin" id="pengizin"  placeholder="Test" class="form-control" required>
						...
						<tr>
							...
							<td>
								<div class="form-group">
									<select name="nama_perizinan" class="form-control" id="nama_perizinan">
										<option value="">-Silahkan Pilih-</option>
					...
					<button type="submit" class='btn btn-primary'>Tambah Perizinan</button>
					<a href="<?= base_url('bakes/perizinan'); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
...
<script>
	function pilih_pelanggaran(){
		...
		$.ajax({
			url:"<?php echo base_url() ?>bakes/perizinan/fill_kategori_pelanggaran",
