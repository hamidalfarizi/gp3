...
<div class="container-fluid text-dark">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800"><strong>Tabel Indeks Emergency 2</strong></h1>
		<h3 class="h5 mb-0 text-gray-800"><em>Santri yang sedang berada di Emergency 2</em></h3>
	</div>
