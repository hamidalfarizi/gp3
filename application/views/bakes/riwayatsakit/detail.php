...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Daftar Detail Riwayat Sakit Santri <?php echo $detail->nama_lengkap ?></td> </h1>
		<a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
			<?php foreach ($datafilter as $row): ?>
			<form action="<?= base_url('bakes/riwayatsakit/print/' . $row->id_siswa)  ?>" method="post" target='_blank'>
