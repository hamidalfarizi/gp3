	...
	<div class="row">
		<div class="col-12">
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					<form action="<?= base_url('bakes/riwayatsakit/edit_riwayatsakit_tabel/'. $riwayatsakit['id_sakit'] ) ?>" method="post">
					...
					<a href="<?= base_url('bakes/riwayatsakit/tabel_riwayatsakit'); ?>" class='btn btn-danger'>Kembali</a>
				</form>
				</div>
			</div>
		</form>
