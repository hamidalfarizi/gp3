	...
	<div class="card shadow mb-6">
		<div class="card-header py-3">
			<div class="d-sm-flex align-items-center justify-content-between mb-4">
				<h1 class="h3 mb-0 text-gray-800"><strong>Jumlah Rekapitulasi Santri Per-Kelas</strong></h1>
				<a href="<?= base_url('rekap_kelas/print'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" target="_blank">
