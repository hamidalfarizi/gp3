    ...
    if (!$ci->ion_auth->logged_in())
	...
	else
		{
			...
			switch($user_groups->name)
			{
				...
				case 'pengasuhansantri':
					// jika sebagai pengasuhan, url yg boleh diakses sebagai berikut
					$url_allowed = [
						'',
						'dashboard',
						'profil',
				...
				case 'kmi':
					// jika sebagai kmi, url yg boleh diakses sebagai berikut
					$url_allowed = [
						'',
						'dashboard',
						'profil',
				...
				case 'inputdata':
					// jika sebagai Input Data, url yg boleh diakses sebagai berikut
					$url_allowed = [
						'',
						'dashboard',
						'profil',
				...
				case 'bahasa':
					// jika sebagai Bahasa, url yg boleh diakses sebagai berikut
					$url_allowed = [
						'',
						'dashboard',
						'bahasa',
...
function user_info()
{
	...
	switch($user_groups->name)
	{
		...
		case 'pengasuhansantri' :
			$user_role = array('user_role' => 'pengasuhansantri');
			return array_merge($data, $user_role);
		break;

		case 'kmi' :
			$user_role = array('user_role' => 'kmi');
			return array_merge($data, $user_role);
		break;

		case 'inputdata' :
			$user_role = array('user_role' => 'inputdata');
			return array_merge($data, $user_role);
		break;

		case 'bakes' :
			$user_role = array('user_role' => 'bakes');
			return array_merge($data, $user_role);
		break;

		case 'bahasa' :
			$user_role = array('user_role' => 'bahasa');
			return array_merge($data, $user_role);
		break;
...
function user_menu()
{
	...
	switch(user_info()['user_role'])
	{
		...
		case 'pengasuhansantri':
			$ci->load->view('pengasuhan/menu_pengasuhan');
		break;

		case 'kmi':
			$ci->load->view('kmi/menu_kmi');
		break;

		case 'inputdata':
			$ci->load->view('menus/menu_inputdata');
		break;

		case 'bakes':
			$ci->load->view('bakes/menu_bakes');
		break;

		case 'bahasa':
			$ci->load->view('bahasa/menu_bahasa');
		break;
